...
const learningAndSupports = [
  ...
  { number: "06", icon: Bus, title: "Transportation", summary: "Reliable travel and clear family communication.", body: "Transportation services prioritize safe, efficient travel to and from school, with communication for families about routes, schedules, and changes.", image: "/images/transportation-card.png" },
