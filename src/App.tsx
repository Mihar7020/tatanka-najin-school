...
const learningAndSupports = [
  { number: "01", icon: Languages, title: "Dakota language", summary: "Language, identity, and connection across generations.", body: "The Dakota Language Program supports language revitalization and cultural preservation through speaking, listening, reading, writing, storytelling, songs, games, and cultural activities.", image: "/images/dakota-language-card.png" },
  ...
  { number: "05", icon: Utensils, title: "Nutrition program", summary: "Wholesome meals that support learning and wellness.", body: "The school kitchen is dedicated to providing wholesome, nutritious meals that fuel students for success in academic and extracurricular pursuits.", image: "/images/nutrition-program-card.png" },
  { number: "06", icon: Bus, title: "Transportation", summary: "Reliable travel and clear family communication.", body: "Transportation services prioritize safe, efficient travel to and from school, with communication for families about routes, schedules, and changes.", image: "/images/tsn-school-faa46f9abb.png" },
